...
- **Active strategies**: Liquidity Sweep (1H), RSI Divergence (1H), Break & Retest (4H) — frozen 2026-07-02 (Confluence Swing and SMC retired; see `server/strategies/registry.ts`). **2026-09-01: the harness/paper "edge" (PF 1.99, +715R) was a look-ahead artefact — LS booked the sweep candle's close as entry, 1–2 bars before the decision. Honest numbers: system PF 1.08 / exp +0.06R, LS alone PF 0.96; only B&R and RSI-div show positive expectancy on small samples. See README ⚠️ note and `script/audit/AUDIT-NOTES.md` Fase 8. Do not quote pre-Sep-2026 backtest numbers as evidence.**
